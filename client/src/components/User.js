...
const User = () => {
    ...
    const [hosdet, sethosdet] = useState([]);



    const dash = (e) => {
        let hospitaldiv = document.getElementById('hospitaldiv');
        e.target.parentElement.classList.add("side-nav__item-active");
        let bottomdiv = document.getElementById('bottom');
        hospitaldiv.style.display = "none";
        bottomdiv.innerHTML = "<p>dash</p>"
    }
    ...
    const hosdetails = (e) => {
        let bottomdiv = document.getElementById('bottom');
        let otherbottomdiv = document.getElementsByClassName("side-nav__item")[0].classList.remove("side-nav__item-active")
        console.log(otherbottomdiv);
        e.target.parentElement.classList.add("side-nav__item-active");

        axios.get('http://localhost:3001/gethospitals').then((response) => {
            sethosdet(response.data);
        }).catch((err) => {
            alert("Error Has Been Ocuured:" + err);
        })
    ...
    const beddetail = (e) => {
        let bottomdiv = document.getElementById('bottom');
        let hosdiv = document.getElementById('hospitaldiv');
        let otherbottomdiv = document.getElementsByClassName("side-nav__item")[0].classList.remove("side-nav__item-active")
        let otherbottomdiv2 = document.getElementsByClassName("side-nav__item")[1].classList.remove("side-nav__item-active")
        console.log(otherbottomdiv);
        e.target.parentElement.classList.add("side-nav__item-active");
        bottomdiv.style.display = "block";
        hosdiv.style.display = "none";
        bottomdiv.innerHTML = "<p>Beds</p>"
    }
    ...
    const docdetails = (e) => {
        ...
        let otherbottomdiv = document.getElementsByClassName("side-nav__item")[0].classList.remove("side-nav__item-active")
        let otherbottomdiv2 = document.getElementsByClassName("side-nav__item")[1].classList.remove("side-nav__item-active")
        let otherbottomdiv3 = document.getElementsByClassName("side-nav__item")[2].classList.remove("side-nav__item-active")
        console.log(otherbottomdiv);
        e.target.parentElement.classList.add("side-nav__item-active");
        bottomdiv.style.display = "block";
        hosdiv.style.display = "none";
        bottomdiv.innerHTML = "<p>docs</p>"
    }
    ...
    const req = (e) => {
        ...
        let otherbottomdiv2 = document.getElementsByClassName("side-nav__item")[1].classList.remove("side-nav__item-active")
        let otherbottomdiv3 = document.getElementsByClassName("side-nav__item")[2].classList.remove("side-nav__item-active")
        let otherbottomdiv4 = document.getElementsByClassName("side-nav__item")[3].classList.remove("side-nav__item-active")
        e.target.parentElement.classList.add("side-nav__item-active");
        bottomdiv.style.display = "block";
        hosdiv.style.display = "none";
        bottomdiv.innerHTML = "<p>req</p>"
    }
    ...
    const dash2 = (e) => {
        let bottomdiv = document.getElementById('bottom');
        let hospitaldiv = document.getElementById('hospitaldiv');
        e.target.parentElement.classList.remove("side-nav__item-active");
        bottomdiv.innerHTML = "<p>dshbchj</p>"
    ...
    const req2 = (e) => {
        ...
        let otherbottomdiv4 = document.getElementsByClassName("side-nav__item")[3].classList.remove("side-nav__item-active")
        e.target.parentElement.classList.remove("side-nav__item-active");
        bottomdiv.innerHTML = "<p>request</p>"
    }
    ...
    const regidiv = (e) => {
        ...
        let otherbottomdiv = document.getElementsByClassName("side-nav__item")[0].classList.remove("side-nav__item-active")
        let otherbottomdiv2 = document.getElementsByClassName("side-nav__item")[1].classList.remove("side-nav__item-active")
        let otherbottomdiv5 = document.getElementsByClassName("side-nav__item")[2].classList.remove("side-nav__item-active")
        let otherbottomdiv3 = document.getElementsByClassName("side-nav__item")[3].classList.remove("side-nav__item-active")
        let otherbottomdiv4 = document.getElementsByClassName("side-nav__item")[4].classList.remove("side-nav__item-active")
        e.target.parentElement.classList.add("side-nav__item-active");
            ...
            <div className="containerdash">
                <nav className="sidebar">
                    <div>
                        <div className="sidebar__logo">
                            ...
                            <h2 className="sidebar__logo-header">CovX</h2>
                        </div>
                        <ul className="side-nav">
                            ...
                            <li className="side-nav__item">
                                ...
                                <span onMouseEnter={hosdetails} onMouseOver={hosdetails2}>Hospitals</span>
                            </li>
                            <li className="side-nav__item">
                                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='dash' onMouseEnter={beddetail} onMouseOver={beddetail2}>Beds</span>
                            </li>
                            <li className="side-nav__item">
                                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='dash' onMouseEnter={docdetails} onMouseOver={docdetail2}>Doctors</span>
                            </li>
                            <li className="side-nav__item">
                                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='dash' onMouseEnter={req} onMouseOver={req2}>Requsets</span>
                            </li>
                            <li className="side-nav__item">
                                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className='dash' onMouseEnter={regidiv} onMouseOver={regidiv2}>Register</span>
                            </li>
                            <li className="side-nav__item">
                                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.79183 17.9166H7.3335C3.66683 17.9166 1.8335 17 1.8335 12.4166V7.83331C1.8335 4.16665 3.66683 2.33331 7.3335 2.33331H14.6668C18.3335 2.33331 20.1668 4.16665 20.1668 7.83331V12.4166C20.1668 16.0833 18.3335 17.9166 14.6668 17.9166H14.2085C13.9243 17.9166 13.6493 18.0541 13.4752 18.2833L12.1002 20.1166C11.4952 20.9233 10.5052 20.9233 9.90016 20.1166L8.52516 18.2833C8.3785 18.0816 8.03933 17.9166 7.79183 17.9166Z" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <span className='dash'>Login</span>
                            </li>
                        </ul>
                ...
                <main className="main-content">
                    <div className="top-container">
                        ...
                        <div className="user-nav">
                            ...
                            <div className="user-info">
                                ...
                                <span className="user-name">Covian</span>
                            </div>
                    ...
                    <div id='hospitaldiv'>
                       ...
                       <h2 style={{display:'block',width:'fit-content','margin':'auto',fontFamily:'cursive'}}>Hospitals</h2>

                        <div style={{display:'grid',"grid-template-columns":'1fr 1fr 1fr',gap:"20px",marginTop:'30px'}}>
                            {   
                                hosdet.map((val) => {
                                return (
                                    <div>
                                        <div className="main" style={{ width: "18rem" }}>
                                            <ul className="cards">
                                                <div className="card">
                                                    {/* <div className="card_image"><img src="https://picsum.photos/500/300/?image=10" /></div> */}
                                                    <div className="card_content">
                                                        <h2 className="card_title">{val.Hos_name}</h2>
                                                        <p className="card_text">Located in {val.Hos_City} and Having Main Doctor as {val.Hos_Doc}</p>
                                                        <button className="btn card_btn">Read</button>
                                                    </div>
                                                </div>
                                            </ul>
                                        </div>
